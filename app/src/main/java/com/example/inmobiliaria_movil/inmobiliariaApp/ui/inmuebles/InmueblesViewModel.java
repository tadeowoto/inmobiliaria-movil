...
public class InmueblesViewModel extends AndroidViewModel {
    ...
    private MutableLiveData<List<Inmueble>> listado = new MutableLiveData<>();
    ...
    public MutableLiveData<List<Inmueble>> getListado() {
        return listado;
    }
    ...
    public void cargarInmuebles(){
        ...
        Call<List<Inmueble>> call = service.obtenerInmuebles("Bearer " + token);

        call.enqueue(new Callback<List<Inmueble>>() {
            @Override
            public void onResponse(Call<List<Inmueble>> call, Response<List<Inmueble>> response) {
                if (response.isSuccessful()){
                    listado.postValue(response.body());
                }
            }
            @Override
